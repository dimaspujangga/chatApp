...
if __name__=="__main__":
    ...
    while True:
        ...
        8. Mengirim pesan ke group: sendgroup [groupname] [message]\n
        9. Mengirim file ke group: sendgroupfile [groupname] [filename]\n
        10. Mengirim pesan ke group realm: sendgrouprealm [name_realm] [groupname] [message]\n
        11. Mengirim file ke group realm: sendgroupfilerealm [name_realm] [groupname] [filename]\n
        12. Melihat pesan: inbox\n
        13. Melihat pesan realm: realminbox [nama_realm]\n
        14. Logout: logout\n
        15. Menambah group: addgroup [nama_group]\n
        16. Melakukan join group: joingroup [nama_group]\n
        17. Melihat user yang aktif: info\n""")
